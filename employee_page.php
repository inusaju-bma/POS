...
<html>
<head>
	<title>Ponit of Sale</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<link rel="icon" type="image/png" sizes="180x180" href="images/icon(1).png">
...
<body>
	<div class="h-100 bg-dark" id="container">
		<div id="header">
			...
			<div>
				<img width="100px" height="100px" style="border-radius: 8px; margin-top: 25px" src="images/postitle.png"/>
			</div>
		...
		<div id="footer" class="w-100" align="center" style="">
			...
			<button id="buttons" onclick="window.location.href='sales/sales_employee.php'" class="btn btn-secondary border mr-2"><i class="fas fa-money-bill-wave"></i> Sales</button>
